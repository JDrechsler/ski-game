...
export const BIOMES: BiomeConfig[] = [
    ...
    },
    {
        ...
        starWeight: 30,
        gemWeight: 50,
        rhinoSpeedMultiplier: 1.5,
    },
];

export const RHINO_SPAWN_SCORE: number = 1500;
